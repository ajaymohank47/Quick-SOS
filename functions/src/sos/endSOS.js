...
exports.endSOS = functions.https.onCall(function (data, context) { return __awaiter(void 0, void 0, void 0, function () {
    var sosId, sosRef, sosDoc, sosData, contacts, tokens, _i, contacts_1, contactUid, contactDoc, contactData, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                contacts = sosData.contactsNotified || [];
                tokens = [];
            ...
            case 6:
                ...
                payload = {
                    notification: {
                        title: "SOS Ended",
                        body: "".concat(sosData.userName, " is safe now.")
                    },
                    data: {
                        sosId: sosId,
                        type: 'SOS_ENDED'
